...
public class CodeGenerateUtils {
    ...
    private final String tableName = "core_comparison_goods_spec";
    private final String packageName = "com.liuxz.codegen";
    private final String tableAnnotation = "质量问题";
    private final String URL = "jdbc:mysql://127.0.0.1:3306/guiderank_server";
    private final String USER = "root";
    private final String PASSWORD = "123456";
    private final String DRIVER = "com.mysql.jdbc.Driver";
    private final String diskPath = "C:\\test\\";
